...
function BookLabAppointment() {
  ...
  const labs = [
    { name: "Metropolis Healthcare", testsAvailable: 10 },
    { name: "Manipal Hospitals", testsAvailable: 15 },
    { name: "Lifecare Medicals", testsAvailable: 20 },
    { name: "Lal Path Labs", testsAvailable: 12 },
  ];
  ...
  const tests = [
    {
      ...
      name: "Blood Test",
      price: 50,
      parameters: "CBC, Glucose, Lipid Profile",
    },
    ...
    { id: 6, name: "CT Scan", price: 150, parameters: "Head CT Scan" },
    {
      ...
      name: "Ultrasound",
      price: 60,
      parameters: "Abdominal Ultrasound",
    },
    ...
    { id: 10, name: "Allergy Test", price: 70, parameters: "Allergens Panel" },
    {
      ...
      name: "Cholesterol",
      price: 800,
      parameters: "Cholesterol Test",
    },
    { id: 12, name: "Folate", price: 450, parameters: "Folate Test" },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    const { data } = await axios.post(
      "http://localhost:8080/lab/appointment",
      {
        name,
        age,
        timestamp: dateTime,
          ...
          <div style={styles.inputContainer}>
            ...
            {selectedLab && (
              <div style={styles.testsAvailable}>
                Tests available:{" "}
                {labs.find((lab) => lab.name === selectedLab)?.testsAvailable}
              </div>
            )}
          </div>
